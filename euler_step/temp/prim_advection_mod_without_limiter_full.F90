...
!#define SW_EULER_STEP_QDP
#ifdef  SW_EULER_STEP_QDP
  call t_startf('euler_step_out_limiter_sw')
  ...
  call athread_join()
  call t_stopf('euler_step_out_limiter_sw')
#else
  call t_startf('euler_step_out_limiter')
  do ie = nets, nete
    do q = 1, qsize
      do k = 1 , nlev
        do j=1,np
      ...
      if ( limiter_option == 4 ) then
        ...
        !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
        print *, "******************iam , limiter_option = 4"
        call limiter2d_zero( elem(ie)%state%Qdp(:,:,:,q,np1_qdp))
      endif
     enddo
  enddo
  call t_stopf('euler_step_out_limiter')
#endif
